...
if ( class_exists( 'FlipperCode_List_Table_Helper' ) and ! class_exists( 'Wpgmp_Maps_Table' ) ) {
	...
	$tableinfo = array(
		...
		'translation' => array(
			...
			'delete_msg'          => esc_html__( 'Maps deleted successfully', 'wpgmp-google-map' ),
			'insert_msg'          => esc_html__( 'Map added successfully', 'wpgmp-google-map' ),
			'update_msg'          => esc_html__( 'Map updated successfully', 'wpgmp-google-map' ),
		),
	);
