				...
				switch ( $block ) {
					...
					case 'product-activation':
						...
						if ( $is_update == true ) {
							...
							$plugin_status = $this->PO['latest_version_available'] . ' <strong>' . $this->newVersion['new_version'] . '</strong>';

							$plugin_action = '<span class="orangebg" name="plugin_update_status" id="plugin_update_status"><a class="codecanyon-link" href="http://www.codecanyon.net/downloads" target="_blank"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;&nbsp;' . $this->PO['updates_available'] . '</a></span>';
					...
					case 'product-support':
						 $this->blockHeading = '<h1>' . $this->PO['product_support']['heading'] . '</h1>';
				      ...
				      <div class="fc-divider fcdoc-brow"> 
	                       	...
	                       	<div class="fc-10">' . $this->PO['product_support']['desc'] . '<br><strong><a class="blue" href="' . $this->docURL . '" target="_blank">' . $this->PO['product_support']['click_here'] . '</a></strong>
                        ...
                        <div class="fc-divider fcdoc-brow"> 
	                       	...
	                       	<div class="fc-10">' . $this->PO['product_support']['desc2'] . '<br><strong><a href="' . $this->demoURL . '" target="_blank" class="blue">' . $this->PO['product_support']['click_here'] . '</a></strong>
